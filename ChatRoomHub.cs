...
using ChatAppSignalR_Raihan.Models;
using Microsoft.AspNet.SignalR;
using Microsoft.AspNet.SignalR.Hubs;

namespace ChatAppSignalR_Raihan
{
    [HubName("chat")]
    public class ChatRoomHub : Hub
    {
        ...
        //public void GetByteArray(string room, IEnumerable<ImageData> images, string user)
        //{
        ...
        //            Clients.Group(room).image(room, new { buffer, sender = user });
        //        }
        //    }
        //}
    }
